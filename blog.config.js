...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xcheng505', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Nobody', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xcheng505.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科研, 生活', // 网站关键词 英文逗号隔开
